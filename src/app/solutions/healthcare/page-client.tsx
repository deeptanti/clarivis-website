...
import { Stethoscope, Microscope, Building, Calendar, Heart, CreditCard, LayoutDashboard, FileSearch } from "lucide-react";

export default function HealthcareSolutionsContent() {
  return (
    <main className="w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center lg:items-start">
            ...
            >
              ...
              <h1 className="text-white text-[36px] lg:text-[52px] font-extrabold leading-[1.1] tracking-tight">
                AI systems built for the way healthcare actually operates.
              </h1>
              <p className="text-[#9CA3AF] text-[18px] leading-[1.8] mt-4 lg:mt-6">
                From appointment no-shows to automated patient management. From manual billing to AI-powered revenue cycle automation. We understand healthcare operations because we have mapped them across clinics, diagnostic centres, and hospitals.
              </p>
            ...
            >
              <div className="bg-[#111827] border border-[#0F6E56]/20 rounded-[20px] p-8 lg:p-[40px]">
                <div className="flex flex-col gap-6">
                  {/* Stat 1 */}
                  <div>
                    <div className="text-[#0F6E56] text-[40px] lg:text-[48px] font-extrabold leading-none tracking-tight">40%</div>
                    <div className="text-[#9CA3AF] text-[15px] mt-2">Average reduction in patient no-shows after deployment</div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-[#9CA3AF] text-[15px] mt-2">Manual billing errors after revenue cycle automation</div>
                  </div>
                  <div className="h-px w-full bg-[#1f2937]" />
                  {/* Stat 3 */}
                  <div>
      ...
      <section className="relative w-full py-[100px] bg-[#0d1117] overflow-hidden">
        <div className="container relative z-10 mx-auto px-6 max-w-[1200px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: Stethoscope, title: "Multispecialty Clinics", tag: "FASTEST SALES CYCLE",
                desc: "Four to fifteen doctors. Founding doctor or clinic manager decides. Sales cycle two to four weeks. Pain points: no-shows, manual billing, no management reporting."
              },
              {
                icon: Microscope, title: "Diagnostic Centres and Labs", tag: "HIGH IMPACT",
                desc: "Owner-pathologist decides commercially. Sales cycle three to five weeks. Pain points: manual report delivery, patient communication gaps, billing errors."
              },
              {
                icon: Building, title: "Mid-sized Hospitals", tag: "HIGHEST TICKET",
                desc: "Fifty to two hundred beds. Multi-stakeholder decision. Sales cycle eight to sixteen weeks. Pain points: operational visibility, staff efficiency, patient experience at scale."
              }
            ].map((profile, idx) => {
      ...
      {/* Section 3: Products for Healthcare */}
          ...
          <div className="mb-6">
            <h2 className="text-white text-[36px] lg:text-[56px] font-extrabold leading-[1.1] tracking-tight">
              <motion.span
                ...
                className="block"
              >
                Ready to reduce no-shows and <span className="text-[#0F6E56]">billing errors</span>?
              </motion.span>
            </h2>
          </div>
